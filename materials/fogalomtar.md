...
| <a id="instruction-budget"></a>**Instrukciókeret** | Nincs minden modellre és feladatra érvényes, igazolt darabszám-plafon. A több, összetettebb, egymással versengő vagy irreleváns instrukció növeli a kihagyás kockázatát, ezért rövid, prioritásos szabálylistával, feladatspecifikus kontextussal, gépi guardraillel és saját eval-lal dolgozunk. |
...
| <a id="orchestrator"></a>**Orchestrator / koordináló agent** | A célt, állapotot, függőségeket, lease-eket és kapukat kezeli; körülhatárolt munkát delegál elkülönített subagenteknek, majd tömör, bizonyítékkal hivatkozott eredményeket szintetizál. A megvalósítás nyers részleteit nem gyűjti szükségtelenül a saját kontextusába. |
| <a id="orchestration-pattern"></a>**Orchestration pattern** | Koordinációs és kontextusmenedzsment-minta: az orchestrator felosztja és állapotgépen vezeti a munkát, minden worker a minimum elégséges kontextust kapja, az eredmény pedig szerződött formában és evidence-szel tér vissza. |
...
| <a id="heartbeat"></a>**Heartbeat** | Időbélyegzett élet- és haladásjel: futásazonosítóval, állapottal, utolsó checkpointtal és utolsó érdemi előrelépéssel jelzi, hogy egy agent vagy orchestrator él-e és halad-e. |
| <a id="watchdog"></a>**Watchdog** | Az agenttől független felügyelő, amely a hiányzó vagy elavult heartbeat, progress-deadline és health check alapján diagnózist, korlátozott recoveryt vagy emberi eszkalációt indít. |
| <a id="health-check"></a>**Health check** | Gépileg ellenőrzött állapotvizsgálat. Külön kezeli a liveness-t (fut-e), readiness-t (fogadhat-e munkát), progresst (halad-e), a függőségek és az evaluatorok egészségét. |
| <a id="self-healing"></a>**Self-healing** | Ismert hibát előre korlátozott playbookkal helyreállító, majd a helyreállást újraellenőrző mechanizmus. Ismeretlen, ismétlődő vagy retry-budgetet kimerítő hibánál megáll és embert riaszt; nem korlátlan önátírás vagy végtelen retry. |
