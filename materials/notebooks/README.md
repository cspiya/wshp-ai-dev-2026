...
A workshop moduljainak tananyaga **magyar nyelvű, önálló HTML-notebook** formában készül. Minden új
vagy átdolgozott modul a futtatható [`_template.html`](_template.html) shellből és a kanonikus
[`visual-contract.md`](visual-contract.md) vizuális szerződésből indul. A notebookokat a GitHub Pages
szolgálja ki weboldalként, és a repóból külső függőség nélkül, offline is megnyithatók.
