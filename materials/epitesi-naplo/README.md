...
Ez nem státusz- vagy handoff-mappa. A mindenkori munkaállapot a Linear issue-kban, lease
kommentekben és commitokban él. A napló azt mutatja meg, **mit bizonyított az adott építési nap**,
...
|---|---|---|---|
| [Day 1](day-1.md) | első teljes RUG-kör | A zöld pipeline nem jelent kész állapotot; friss review és regressziós védelem is kell. | Day 2: erősítsük meg az architektúra- és teszthatárokat. |
