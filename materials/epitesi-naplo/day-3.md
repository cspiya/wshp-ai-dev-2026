...
*A nap terméke: a toolkit (RUG-munkafolyamat, kanonikus standardok, hookok, sablonok), a 8 notebook első
...
[big picture](../big-picture.md) · előzmény: [Day 2](day-2.md)*

**Linear:** WEN-118/129/141 párhuzamos futás · WEN-116 ✅ (a lánc élesben) · WEN-161/162 ✅ (repo-init +
material-standardok) · WEN-171 ✅ (a handoff-fájl nyugdíjazása — a munkaállapot a Linearé)
...
flowchart LR
    ...
    F --> W["🌐 WEN-116 élő drótozás<br/>böngésző-agent + emberi kapuk<br/>(9 csapda feltárva)"]
...
és törölte a preview-adatbázist. *A lebontás a git-branch törléséhez kötött — ez maga is tanítható tény.*
...
handoff-fájl archívumba került. A tanítási pont: *a státusz-fájl abban a pillanatban hazudik, amikor
két session ír egyszerre — a tracker nem.*
...
<details>
<summary>🧑 <b>H2 · Repo-init: a spec-first kapu kódba öntése</b> (WEN-161/162)</summary>
...
<details>
<summary>🤖 <b>A4 · Handoff-nyugdíjazás tartalom-költöztetéssel</b> (WEN-171)</summary>
