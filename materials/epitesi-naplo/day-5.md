...
Egy ember által előre kiválasztott vizuális irány kidolgozása v0-ban vagy Claude Designban, emberi
elfogadási döntés, majd a kiválasztott UI integrálása. Ezután ugyanazon elfogadott SHA-n kell lezárni
az élő Neon Auth, Preview browser/API/DB evidencia és a nulláról újrajátszható runbook kapuit.
