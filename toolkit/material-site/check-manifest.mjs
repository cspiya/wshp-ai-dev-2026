...
export const FROZEN_ROUTES = new Map([
  ...
  ['/materials/repo-terkep/', { source: 'materials/repo-terkep/index.html', output: 'materials/repo-terkep/index.html', parent: '/materials/', order: 1, owner: 'MATERIALS-HUB' }],
  ['/materials/felkeszules/', { source: 'materials/felkeszules/index.html', output: 'materials/felkeszules/index.html', parent: '/materials/', order: 2, owner: 'MATERIALS-HUB' }],
  ['/materials/napirend/', { source: 'materials/napirend/index.html', output: 'materials/napirend/index.html', parent: '/materials/', order: 3, owner: 'MATERIALS-HUB' }],
  ['/materials/modszertan/', { source: 'materials/modszertan/index.html', output: 'materials/modszertan/index.html', parent: '/materials/', order: 4, owner: 'MATERIALS-HUB' }],
  ['/materials/agent-ready-repo/', { source: 'materials/agent-ready-repo/index.html', output: 'materials/agent-ready-repo/index.html', parent: '/materials/', order: 5, owner: 'MATERIALS-HUB' }],
  ['/materials/minoseg/', { source: 'materials/minoseg/index.html', output: 'materials/minoseg/index.html', parent: '/materials/', order: 6, owner: 'MATERIALS-HUB' }],
  ['/materials/eszkozok/', { source: 'materials/eszkozok/index.html', output: 'materials/eszkozok/index.html', parent: '/materials/', order: 7, owner: 'MATERIALS-HUB' }],
  ['/materials/fogalomtar/', { source: 'materials/fogalomtar/index.html', output: 'materials/fogalomtar/index.html', parent: '/materials/', order: 8, owner: 'GLOSSARY' }],
  ['/materials/modulok/', { source: 'materials/modulok/index.html', output: 'materials/modulok/index.html', parent: '/', order: 2, owner: 'MATERIALS-HUB' }],
  ...
  ['/toolkit/', { source: 'toolkit/index.html', output: 'toolkit/index.html', parent: '/', order: 3, owner: 'TOOLKIT-WEB' }],
  ...
  ['/participant-starter/', { source: 'participant-starter/index.html', output: 'participant-starter/index.html', parent: '/', order: 4, owner: 'STARTER-WEB' }],
  ['/reference-app/', { source: 'reference-app/index.html', output: 'reference-app/index.html', parent: '/', order: 5, owner: 'REFERENCE-WEB' }],
]);
