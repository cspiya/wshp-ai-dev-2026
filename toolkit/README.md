...
| [`golden-thread/README.md`](golden-thread/README.md) | A nap egyetlen munkadarabja (KK-Regisztráció): kitalált brief, referencia spec-csomag és known-good/partial/broken pillanatképek tartalék-útvonalként | C3–C6 minta és Plan B | A választott snapshot és a váltás oka az evidence-ben rögzítve; a saját spec-csomag ettől független marad |
| [`checklists/workshop-passport.md`](checklists/workshop-passport.md) | C0–C7 passport: minden állomás evidence-hez kötött, pecsételhető lezárása | C0–C7 | Állomásonként a megnevezett evidence-fájl megléte — pecsét csak bizonyítékra jár |
